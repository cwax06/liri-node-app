...
prompt.message = colors.blue("Type one of the following: tweets, spotify-this-song, movie, or random");
...
prompt.get({
    ...
    //if the user enters spotify-this-song it will prompt you and ask for the song you want to look up and then it will run the mySpotify function based on those results. if the user doesnt enter a song it defaults to Blue and gets that information
    ...
    // if the user selects movie it will prompt the user to state what movie they want to look up and then it will get that information from omdb api if the prompt is left blank the function will default and look up Mr Nobody and reutrn that information
        ...
        //if the user chooses 'random' then the function lastOption is run using the information from the random.txt file
